...
export declare class ComboBoxComponent implements ControlValueAccessor, OnDestroy, OnChanges {
    ...
    private direction;
    constructor(localization: LocalizationService, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, cdr: ChangeDetectorRef, renderer: Renderer2, wrapper: ElementRef, touchEnabled: boolean);
    ngOnInit(): void;

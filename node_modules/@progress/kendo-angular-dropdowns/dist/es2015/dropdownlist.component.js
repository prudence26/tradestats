...
export class DropDownListComponent {
    constructor(localization, popupService, selectionService, navigationService, _zone, renderer, hostElement, cdr, touchEnabled) {
    ...
    createSelectionStream() {
        ...
        this.selectionSubscription = this.selectionSubject.pipe(map((index) => {
            let dataItem;
            if (!this.data.length && this.filterText && this.dataItem) {
                dataItem = this.dataItem;
            }
            else {
                dataItem = isPresent(this.data[index]) ? this.data[index] : this.defaultItem;
            }
            return {
                dataItem: dataItem,
